...
class Pedido(Base):
    ...
    servicio_10_porciento_bs = Column(Numeric(12, 2), default=0, nullable=False)
    servicio_10_porciento_usd = Column(Numeric(10, 2), default=0, nullable=False)
    pagado_bs = Column(Numeric(12, 2), default=0, nullable=False)
    pagado_usd = Column(Numeric(10, 2), default=0, nullable=False)
    propina_monto_bs = Column(Numeric(12, 2), default=0, nullable=False)
    propina_monto_usd = Column(Numeric(10, 2), default=0, nullable=False)
